...
use App\Services\Web\MetricService;
use Exception;
...
class MetricController extends BaseController
{
     ...
     * path="/metrics",
     * tags = {"Web Metrics"},
     * summary = "To get the list of Web Metrics",
     * operationId = "To get the list of Web Metrics",
    ...
    public function index(Request $request)
    {
        try {
            ...
            $listData          = $this->metricService->list($postData, $skip, $pageLimit, 0);
            $count             = 0;
            $rows              = [];
            $downloadExportUrl = "";
     ...
     * path="/metrics/create",
     * tags = {"Web Metrics"},
     * summary = "To add Web Metrics",
     * operationId = "To add Web Metrics",
     * security={{"bearer_token":{}}, {"x_localization":{}}},
     *     @OA\Parameter(
     *       name="expression_ids[]",
     *       in="query",
    ...
    /**
     * @OA\Post(
     * path="/metrics/{id}/update",
     * tags = {"Web Metrics"},
     * summary = "To update Web Metrics details",
     * operationId = "To update Web Metrics details",
     * security={{"bearer_token":{}}, {"x_localization":{}}},
     *
     *      @OA\Parameter(
     *      name="id",
    ...
    /**
     * @OA\Delete(
     * path="/metrics/{id}/delete",
     * tags = {"Web Metrics"},
     * summary = "To delete Web Metrics",
     * operationId = "To delete Web Metrics",
     * security={{"bearer_token":{}}, {"x_localization":{}}},
     *
     *      @OA\Parameter(
     *          name = "id",
    ...
    /**
     * @OA\Get(
     * path="/metrics/{id}/details",
     * tags = {"Web Metrics"},
     * summary = "To check Web Metrics details",
     * operationId = "To check Web Metrics details",
     * security={{"bearer_token":{}}, {"x_localization":{}}},
     *
     *      @OA\Parameter(
     *          name = "id",
    ...
    /**
     * @OA\Post(
     * path="/metrics/{id}/change-status",
     * tags = {"Web Metrics"},
     * summary = "To change status of Web Metrics",
     * operationId = "To change status of Web Metrics",
     * security={{"bearer_token":{}}, {"x_localization":{}}},
     *
     *      @OA\Parameter(
     *          name = "id",
