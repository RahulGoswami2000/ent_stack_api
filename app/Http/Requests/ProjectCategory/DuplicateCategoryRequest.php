...
class DuplicateCategoryRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'company_stack_category_id.required' => __('validation.required.text', ['attribute' => __('labels.project_name')]),
            ...
            'company_stack_category_id.exists'   => __('validation.exists', ['attribute' => __('labels.company')]),
        ];
    }
